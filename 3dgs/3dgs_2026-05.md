...
| 2026-05-15 | [GSDrive](#5-gsdrive-reinforcing-driving-policies-by-multi-mode-future-trajectory-probing-with-3d-gaussian-splatting-environment) | [2604.28111](https://arxiv.org/abs/2604.28111) | cs.RO | 3DGS 环境多模式轨迹探测+RL 强化驾驶策略（v2） |
| 2026-05-15 | ★ **[GRaD-Nav++](#6-grad-nav-vision-language-model-enabled-visual-drone-navigation-with-gaussian-radiance-fields-and-differentiable-dynamics)** | [2506.14009](https://arxiv.org/abs/2506.14009) | cs.RO | 3DGS 仿真+DiffRL 训练板载语言无人机导航（IEEE RAL） |
...
| 2026-05-14 | [St. John's Co-Cathedral](#6-st-johns-co-cathedral-large-scale-photogrammetric-documentation-of-st-johns-co-cathedral-a-workflow-for-cultural-heritage-preservation) | [2604.24316](https://arxiv.org/abs/2604.24316) | cs.GR | 大规模文化遗产摄影测量，300亿三角面，3DGS 实验 |
...
| 2026-05-13 | [G-SHARP](#7-g-sharp-gaussian-surgical-hardware-accelerated-real-time-pipeline) | [2512.02482](https://arxiv.org/abs/2512.02482) | cs.CV | 商用许可实时手术 3DGS 重建，部署于 IGX Orin/Thor |
| 2026-05-13 | ★ **[SkySplat](#8-skysplat-generalizable-3d-gaussian-splatting-from-multi-temporal-sparse-satellite-images)** | [2508.09479](https://arxiv.org/abs/2508.09479) | cs.CV | 多时相稀疏卫星图像可泛化 3DGS，RPC 模型集成（AAAI'26） |
| 2026-05-13 | ★ **[3D-UIR](#9-3d-uir-3d-gaussian-for-underwater-3d-scene-reconstruction-via-physics-based-appearance-medium-decoupling)** | [2505.21238](https://arxiv.org/abs/2505.21238) | cs.CV | 物理外观-介质解耦，水下 3D 场景重建（IEEE TIP'26） |
...
| 2026-05-12 | ★ **[Compact 3DGS SLAM](#9-compact-3d-gaussian-splatting-for-dense-visual-slam)** | [2403.11247](https://arxiv.org/abs/2403.11247) | cs.CV | 滑动窗口掩码+几何码本压缩，紧凑 3DGS SLAM（IJCV'26） |
...
| 2026-05-11 | [4D-NVS](#7-4d-neural-voxel-splatting-dynamic-scene-rendering-with-voxelized-gaussian-splatting) | [2511.00560](https://arxiv.org/abs/2511.00560) | cs.CV | 4D 神经体素光栅化，体素+形变场高效动态场景建模 |
...
| 2026-05-09 | [ELoG-GS](#5-elog-gs-dual-branch-gaussian-splatting-with-luminance-guided-enhancement-for-extreme-low-light-3d-reconstruction) | [2604.12592](https://arxiv.org/abs/2604.12592) | cs.CV | 亮度引导增强双分支 3DGS，极弱光 3D 重建（NTIRE 排名 9/148） |
| 2026-05-09 | [NiFi](#6-nix-and-fix-targeting-1000x-compression-of-3d-gaussian-splatting-with-diffusion-models) | [2602.04549](https://arxiv.org/abs/2602.04549) | cs.CV | 扩散模型一步蒸馏，3DGS 极端压缩至 1000x |
| 2026-05-09 | ★ **[Turbo-GS](#7-turbo-gs-accelerating-3d-gaussian-fitting-for-high-quality-radiance-fields)** | [2412.13547](https://arxiv.org/abs/2412.13547) | cs.CV | 稀释渲染+收敛感知预算控制，加速 3DGS 拟合（CVPR'26） |
...
| 2026-05-08 | [PropSplat](#9-propsplat-map-free-rf-field-reconstruction-via-3d-gaussian-propagation-splatting) | [2605.08035](https://arxiv.org/abs/2605.08035) | eess.SP | 无地图 RF 场重建，3D 高斯传播拼接（IEEE DySPAN'26） |
| 2026-05-08 | [LR-SGS](#10-lr-sgs-robust-lidar-reflectance-guided-salient-gaussian-splatting-for-self-driving-scene-reconstruction) | [2603.12647](https://arxiv.org/abs/2603.12647) | cs.CV | 激光雷达反射率引导显著高斯，自动驾驶场景重建 |
...
| 2026-05-07 | [MesonGS++](#4-mesongs-post-training-compression-of-3d-gaussian-splatting-with-hyperparameter-searching) | [2604.26799](https://arxiv.org/abs/2604.26799) | cs.CV | 后训练压缩超参数搜索，34x 压缩 |
| 2026-05-07 | ★ **[AdamW-GS](#5-a-step-to-decouple-optimization-in-3dgs)** | [2601.16736](https://arxiv.org/abs/2601.16736) | cs.CV | 3DGS 优化解耦分析，AdamW-GS 优化器（ICLR'26） |
...
| 2026-05-06 | ★ **[RetimeGS](#7-retimogs-continuous-time-reconstruction-of-4d-gaussian-splatting)** | [2603.13783](https://arxiv.org/abs/2603.13783) | cs.CV | 连续时间 4DGS 重建，任意时间戳渲染（CVPR'26） |
| 2026-05-06 | ★ **[LTGS](#8-ltgs-long-term-gaussian-scene-chronology-from-sparse-view-updates)** | [2510.09881](https://arxiv.org/abs/2510.09881) | cs.CV | 长期高斯场景编年史，稀疏视角更新（CVPR'26 Findings） |
| 2026-05-06 | [RoDyGS](#9-rodysg-robust-dynamic-gaussian-splatting-for-casual-videos) | [2412.03077](https://arxiv.org/abs/2412.03077) | cs.CV | 鲁棒动态 3DGS，休闲视频动态场景重建 |
| 2026-05-06 | [KFC-W](#10-kfc-w-generating-3d-consistent-videos-from-unposed-internet-photos) | [2411.13549](https://arxiv.org/abs/2411.13549) | cs.CV | 从无位姿网络照片生成 3D 一致视频 |
| 2026-05-06 | [Radio Map Tutorial](#11-a-tutorial-on-learning-based-radio-map-construction-data-paradigms-and-physics-awareness) | [2603.17499](https://arxiv.org/abs/2603.17499) | eess.SY | 学习型无线电地图构建教程，涵盖 3DGS 用于连续辐射场建模 |
...
| 2026-05-04 | ★ **[VRGaussianAvatar](#2-vrgaussianavatar-integrating-3d-gaussian-avatars-into-vr)** | [2602.01674](https://arxiv.org/abs/2602.01674) | cs.CV | HMD 驱动的实时 3DGS VR 数字人（IEEE VR'26） |
| 2026-05-04 | [LGDWT-GS](#3-lgdwt-gs-local-and-global-discrete-wavelet-regularized-3d-gaussian-splatting-for-sparse-view-scene-reconstruction) | [2601.17185](https://arxiv.org/abs/2601.17185) | cs.CV | 局部+全局小波正则化，稀疏视角重建 |
| 2026-05-04 | ★ **[Digital Twin](#4-a-high-fidelity-digital-twin-for-robotic-manipulation-based-on-3d-gaussian-splatting)** | [2601.03200](https://arxiv.org/abs/2601.03200) | cs.RO | 3DGS 高保真数字孪生，机器人操作（JRL） |
| 2026-05-04 | [Chorus](#5-chorus-multi-teacher-pretraining-for-holistic-3d-gaussian-scene-encoding) | [2512.17817](https://arxiv.org/abs/2512.17817) | cs.CV | 多教师蒸馏 3DGS 场景编码器，全任务泛化 |
| 2026-05-04 | ★ **[Flux4D](#6-flux4d-flow-based-unsupervised-4d-reconstruction)** | [2512.03210](https://arxiv.org/abs/2512.03210) | cs.CV | 无监督流式 4D 重建，大规模动态场景（NeurIPS'25） |
| 2026-05-04 | [AR Disaster Response](#7-interactive-augmented-reality-enabled-outdoor-scene-visualization-for-enhanced-real-time-disaster-response) | [2602.21874](https://arxiv.org/abs/2602.21874) | cs.HC | 3DGS 户外 AR 灾难响应可视化 |
...
| 2026-05-03 | [DynFOA](#4-dynfoa-generating-first-order-ambisonics-with-conditional-diffusion-for-dynamic-and-acoustically-complex-360-degree-videos) | [2602.06846](https://arxiv.org/abs/2602.06846) | cs.SD | 3DGS 场景重建+扩散模型生成空间音频 |
...
| 2026-05-02 | ★ **[SaLF](#4-salf-sparse-local-fields-for-multi-sensor-rendering-in-real-time)** | [2507.18713](https://arxiv.org/abs/2507.18713) | cs.CV | 稀疏局部场多传感器实时渲染，相机+LiDAR（ICRA'26） |
| 2026-05-02 | [3DGS vs Moving Objects](#5-3d-gaussian-splatting-against-moving-objects-for-high-fidelity-street-scene-reconstruction) | [2503.12001](https://arxiv.org/abs/2503.12001) | cs.CV | 自适应透明度移除运动物体，街道场景重建 |
| 2026-05-02 | [GSDeformer](#6-gsdeformer-direct-real-time-and-extensible-cage-based-deformation-for-3d-gaussian-splatting) | [2405.15491](https://arxiv.org/abs/2405.15491) | cs.CV | 3DGS 笼形形变，实时可扩展无需重训练 |
...
| 2026-05-01 | ★ **[Semantic Foam](#4-semantic-foam-unifying-spatial-and-semantic-scene-decomposition)** | [2604.26262](https://arxiv.org/abs/2604.26262) | cs.CV | Voronoi 网格+语义场，对象级场景分解（CVPR'26 Highlight） |
| 2026-05-01 | [VecSet-Edit](#5-vecset-edit-unleashing-pre-trained-lrm-for-mesh-editing-from-single-image) | [2602.04349](https://arxiv.org/abs/2602.04349) | cs.CV | VecSet LRM 骨干的单图网格编辑 |
| 2026-05-01 | [LCD-GS](#6-high-dynamic-range-3d-gaussian-splatting-via-luminance-chromaticity-decomposition) | [2511.12895](https://arxiv.org/abs/2511.12895) | cs.CV | 亮度-色度解耦 HDR 3DGS，极宽动态范围 |
...
- **arXiv**: [2604.28111](https://arxiv.org/abs/2604.28111) (v2)
- **作者**: Ziang Guo, Chen Min, Xuefeng Zhang, Yixiao Zhou et al.
- **类别**: cs.RO

**摘要**: 端到端自动驾驶中，传统 RL 依赖延迟的事件级奖励（如碰撞），导致策略过早收敛到次优行为。GSDrive 使用可微 3DGS 环境进行未来感知轨迹探测和奖励塑造：先通过 IL 学习多模式轨迹探测，再用 RL 在 3DGS 环境中评估多个候选未来，将模拟回报转换为密集塑造奖励。形成循环混合 IL-RL 训练流程。在 nuScenes 重建数据集上，闭环实验超越其他基于仿真的 RL 方法。

---

### 6. GRaD-Nav++: Vision-Language Model Enabled Visual Drone Navigation with Gaussian Radiance Fields and Differentiable Dynamics

- **arXiv**: [2506.14009](https://arxiv.org/abs/2506.14009)
- **作者**: Qianzhong Chen, Naixiang Gao, Suning Huang, JunEn Low et al.
- **类别**: cs.RO
- **备注**: IEEE Robotics and Automation Letters 发表

**摘要**: 能在非结构化环境中理解并执行高层语言指令的自主无人机仍是长期目标。GRaD-Nav++ 是轻量级 VLA 框架，完全板载运行并实时遵循自然语言指令。策略在逼真的 3DGS 模拟器中通过可微强化学习（DiffRL）训练，核心为混合专家（MoE）动作头，自适应路由计算以改善泛化并减轻遗忘。多任务泛化实验中，训练任务成功率 83%，未见任务 75%。实机部署上，训练任务 67%，未见任务 50%。
...
### 6. Large-Scale Photogrammetric Documentation of St. John's Co-Cathedral: A Workflow for Cultural Heritage Preservation

- **arXiv**: [2604.24316](https://arxiv.org/abs/2604.24316)
- **作者**: Matthew Kenely, Mark Bugeja, Andre Grima, Peter Pullicino, Matthew Pullicino, Dylan Seychell
- **类别**: cs.GR

**摘要**: 马耳他瓦莱塔的圣约翰大教堂（UNESCO 世界遗产）的大规模摄影测量记录方法。七个夜晚采集了 99,000 张照片，结合 DSLR、无人机和 LIDAR 扫描，创建包含 25-300 亿三角面的高精度 3D 重建。完整流程涵盖多模态数据采集、图像分级、AI 辅助降噪、LIDAR 点云清理、RealityCapture 混合重建和网格细分策略。同时初步实验了 Gaussian Splatting 作为补充表示技术。为文化遗产专业人员提供了可复制的工作流程。
...
### 7. G-SHARP: Gaussian Surgical Hardware Accelerated Real-time Pipeline

- **arXiv**: [2512.02482](https://arxiv.org/abs/2512.02482)
- **作者**: Vishwesh Nath, Javier G. Tejero, Aravind S. Kumar, Ruilong Li et al.
- **类别**: cs.CV

**摘要**: 面向侵入式手术的商用兼容实时手术场景重建框架。现有手术高斯光栅实现常依赖非商业衍生版。G-SHARP 是首个原生基于 GSplat（Apache-2.0）可微高斯光栅化的手术管线，支持原则性的形变建模和鲁棒遮挡处理。在 EndoNeRF 拉取基准上达到 SOTA 重建质量，速度-精度权衡适合术中应用。提供 Holoscan SDK 应用，部署于 NVIDIA IGX Orin 和 Thor 边缘硬件。

---

### 8. SkySplat: Generalizable 3D Gaussian Splatting from Multi-Temporal Sparse Satellite Images

- **arXiv**: [2508.09479](https://arxiv.org/abs/2508.09479)
- **作者**: Xuejun Huang, Xinyi Liu, Yi Wan, Zhi Zheng et al.
- **类别**: cs.CV
- **备注**: AAAI 2026

**摘要**: 从稀疏视角卫星图像进行 3D 场景重建。现有 3DGS 方法不兼容 RPC 模型且泛化能力有限。SkySplat 提出自监督框架，将 RPC 模型集成到可泛化 3DGS 管线中。仅需 RGB 图像和辐射鲁棒的相对高度监督。跨自一致性模块（CSCM）通过一致性掩码减轻瞬态物体干扰，多视角一致性聚合策略精炼重建。相比每场景优化方法，速度提升 86 倍且精度更高。在 DFC19 上 MAE 从 13.18m 降至 1.80m。

---

### 9. 3D-UIR: 3D Gaussian for Underwater 3D Scene Reconstruction via Physics Based Appearance-Medium Decoupling

- **arXiv**: [2505.21238](https://arxiv.org/abs/2505.21238)
- **作者**: Jieyu Yuan, Yujun Li, Yuanlin Zhang, Chunle Guo et al.
- **类别**: cs.CV
- **备注**: IEEE TIP 2026

**摘要**: 水下场景新视角合成因复杂光-介质交互而面临独特挑战。3DGS 在水下非均匀环境中因散射介质产生伪像和外观不一致。本文提出物理驱动框架，通过定制高斯建模将物体外观与水介质效应解耦。引入外观嵌入作为后向散射和衰减的显式介质表示。深度引导优化策略利用伪深度图作为监督。在渲染质量和恢复精度上均显著超越现有方法。
...
### 9. Compact 3D Gaussian Splatting For Dense Visual SLAM

- **arXiv**: [2403.11247](https://arxiv.org/abs/2403.11247)
- **作者**: Tianchen Deng, Chang Nie, Shuhong Liu, Wenhua Wu et al.
- **类别**: cs.CV, cs.RO
- **备注**: IJCV 2026

**摘要**: 3DGS SLAM 因大量冗余高斯椭球导致高存储成本和慢训练。本文提出紧凑 3DGS SLAM 系统，通过滑动窗口掩码策略减少冗余椭球。观察到大多数高斯协方差矩阵极度相似，由此引入几何码本压缩几何属性参数。全局 Bundle Adjustment 配合重投影损失实现稳健位姿估计。训练和渲染速度均更快，同时保持 SOTA 场景表示质量。
...
### 7. 4D Neural Voxel Splatting: Dynamic Scene Rendering with Voxelized Gaussian Splatting

- **arXiv**: [2511.00560](https://arxiv.org/abs/2511.00560)
- **作者**: Chun-Tin Wu, Jun-Cheng Chen
- **类别**: cs.CV

**摘要**: 将 3DGS 扩展到动态场景需在帧间复制高斯导致大量内存开销。4D-NVS 结合体素表示与神经高斯光栅化，用紧凑的神经体集合和学习的形变场建模时序动态，大幅降低内存消耗并加速训练。引入新视角细化阶段针对性优化困难视角，保持全局效率的同时提升渲染质量。
...
### 5. ELoG-GS: Dual-Branch Gaussian Splatting with Luminance-Guided Enhancement for Extreme Low-light 3D Reconstruction

- **arXiv**: [2604.12592](https://arxiv.org/abs/2604.12592)
- **作者**: Yuhao Liu, Dingju Wang, Ziyang Zheng
- **类别**: cs.CV
- **备注**: NTIRE 2026 3D Restoration and Reconstruction Challenge Track 1 排名 9/148

**摘要**: 面向极端弱光 3D 重建挑战赛的双分支 3DGS 方法。集成基于学习的点云初始化和亮度引导的颜色增强，在极低光照条件下实现稳定且逼真的 3D 重建。几何感知初始化与光度自适应策略结合，在 NTIRE 榜单上 PSNR 达 18.66、SSIM 0.6855。

---

### 6. Nix and Fix: Targeting 1000x Compression of 3D Gaussian Splatting with Diffusion Models

- **arXiv**: [2602.04549](https://arxiv.org/abs/2602.04549)
- **作者**: Cem Eteke, Enzo Tartaglione
- **类别**: cs.CV

**摘要**: 3DGS 的高存储需求限制了速率受限场景的应用。NiFi 提出通过感知伪影的一步扩散蒸馏实现极端 3DGS 压缩，在极低速率下（低至 0.1MB）实现最先进的感知质量，相比 3DGS 向 1000x 速率改进，同时保持可比感知性能。
...
- **作者**: Ankit Dhiman, Tao Lu, R Srinath, Emre Arslan et al.
- **类别**: cs.CV
- **备注**: CVPR 2026 录用

**摘要**: 3DGS 训练尤其在高分辨率图像上缓慢，常需数小时适配 200 视角场景。Turbo-GS 引入稀释渲染技术仅渲染像素子集大幅降低计算成本，开发收敛感知预算控制机制平衡新高斯添加与现有优化，并 incorpor 位置和外观误差提升加密效率。实现快速 4K 分辨率拟合同时保持甚至提升渲染质量。
...
- **arXiv**: [2605.08035](https://arxiv.org/abs/2605.08035)
- **作者**: William Bjorndahl, Maninder Pal Singh, Farhad Nouri, Joseph Camp
- **类别**: eess.SP, cs.LG
- **备注**: IEEE DySPAN 2026 录用

**摘要**: 无地图 RF 场重建方法。用 3D 各向异性高斯基元编码相对基线路径损耗模型的可学习路径损耗偏移，高斯沿观测收发路径初始化并端到端优化，无需外部地图或地形数据。大规模户外路测中 RMSE 达 5.38dB（优于 WRF-GS+ 的 5.87dB），室内蓝牙定位误差 0.19m。

---

### 10. LR-SGS: Robust LiDAR-Reflectance-Guided Salient Gaussian Splatting for Self-Driving Scene Reconstruction

- **arXiv**: [2603.12647](https://arxiv.org/abs/2603.12647)
- **作者**: Ziyu Chen, Fan Zhu, Hui Zhu, Deyi Kong et al.
- **类别**: cs.CV, cs.AI

**摘要**: 激光雷达反射率引导的显著高斯 3DGS 方法。引入结构感知显著高斯表示，从 LiDAR 提取几何和反射率特征点初始化，经显著变换和改进密度控制捕获边缘和平面结构。将 LiDAR 强度校准为反射率并附加到每个高斯作为光照不变材料通道，与 RGB 联合对齐强制边界一致性。在 Waymo 上超越 OmniRe 1.18dB PSNR。
...
### 4. MesonGS++: Post-training Compression of 3D Gaussian Splatting with Hyperparameter Searching

- **arXiv**: [2604.26799](https://arxiv.org/abs/2604.26799)
- **作者**: Shuzhao Xie, Junchen Ge, Weixiang Zhang, Jiahang Liu et al.
- **类别**: cs.CV, cs.GR, cs.MM

**摘要**: 感知目标大小的 3DGS 后训练编解码器。结合基于联合重要性的剪枝、Octree 几何编码、属性变换、高阶球面谐波选择性矢量量化和分组混合精度量化与熵编码。将保留率和位宽分配作为主要率失真控制旋钮，在目标存储预算下通过离散采样和 0-1 整数线性规划联合优化。实现 34x 压缩同时保持渲染保真度，Stump 场景 20x 压缩下 PSNR 超越原生 3DGS。

---

### 5. A Step to Decouple Optimization in 3DGS

- **arXiv**: [2601.16736](https://arxiv.org/abs/2601.16736)
- **作者**: Renjie Ding, Yaonan Wang, Min Liu, Jialin Zhu et al.
- **类别**: cs.CV
- **备注**: ICLR 2026 录用

**摘要**: 3DGS 优化中两个被忽视的细节：(i) 更新步耦合导致优化器状态重新缩放和视点外属性更新的成本，(ii) 矩中的梯度耦合可能导致正则化不足或过度。将优化过程解耦为 Sparse Adam、Re-State 正则化和 Decoupled Attribute 正则化三部分。重新设计并提出 AdamW-GS，通过重新组合有益组件同时实现更好的优化效率和表示效果。
...
### 7. RetimeGS: Continuous-Time Reconstruction of 4D Gaussian Splatting
...
**摘要**: 时序重定时（在任意时间戳重建和渲染动态场景）对慢动作回放和后期制作至关重要。现有 4DGS 方法在离散帧索引上过拟合，在时间戳间插值时产生幽灵伪像。RetimeGS 将此类局限识别为时间混叠，提出显式定义 3D 高斯时间行为的 4DGS 表示。结合光流引导初始化与监督、三重渲染监督等策略，实现无幽灵、时序连贯的渲染。

---

### 8. LTGS: Long-Term Gaussian Scene Chronology From Sparse View Updates

- **arXiv**: [2510.09881](https://arxiv.org/abs/2510.09881)
- **作者**: Minkwan Kim, Seungmin Lee, Junho Kim, Young Min Kim
- **类别**: cs.CV
- **备注**: CVPR 2026 Findings 录用

**摘要**: 日常环境频繁的场景变化需要密集的空间和时间观测。LTGS 从不完整的非结构化 3DGS 表示出发，即使突发移动和环境细微变化也能鲁棒地建模长期场景编年史。将对象构建为模板高斯作为结构可重用先验，后经精炼管线调制先验以适应时间变化环境。通过简单变换实现多时间步泛化，显著提升可扩展性。

---

### 9. RoDyGS: Robust Dynamic Gaussian Splatting for Casual Videos

- **arXiv**: [2412.03077](https://arxiv.org/abs/2412.03077)
- **作者**: Junmyeong Lee, Hoseung Choi, Yoonwoo Jeong, Minsu Cho
- **类别**: cs.CV

**摘要**: 从休闲捕获的单眼视频进行 4D 重建因重建动态 3D 几何的固有模糊性而具挑战性。RoDyGS 显式分离静态和动态场景元素，应用时空正则化强制物理合理几何和时序一致运动。提出 Kubric-MRig 基准，提供广泛的相机和物体运动及同步多视角捕获，在之前基准中这些特征缺失。
...
- **作者**: Gene Chou, Kai Zhang, Sai Bi, Hao Tan et al.
- **类别**: cs.CV

**摘要**: 从无位姿互联网照片生成视频。少量输入图像作为关键帧，模型在它们之间插值以模拟相机间路径。设计自监督方法利用视频一致性和多视角网络照片的变异性，无需相机参数等 3D 标注训练可扩展的 3D 感知视频模型。在几何和外观一致性上超越所有基线，并受益于相机控制等应用。

---

### 11. A Tutorial on Learning-Based Radio Map Construction: Data, Paradigms, and Physics-Awareness

- **arXiv**: [2603.17499](https://arxiv.org/abs/2603.17499)
- **作者**: Xiucheng Wang, Yuhao Pan, Nan Cheng
- **类别**: eess.SY, eess.SP

**摘要**: 学习型无线电地图构建的全面教程，系统覆盖三个维度：数据（物理测量、射线追踪仿真和基准数据集）、范式（从源感知前向预测到源无关逆重建的分类）、以及物理感知（数据级特征工程、损失级偏微分方程正则化、架构级结构同构）。此外还调用了从神经辐射场和 3D 高斯光栅化启发的光学灵感方法，用于连续无线辐射场建模。讨论了基础模型开发、物理幻觉检测和实时部署等开放挑战。
...
- **arXiv**: [2602.01674](https://arxiv.org/abs/2602.01674)
- **作者**: Hail Song, Boram Yoon, Seokhwan Yang, Seoyoung Kang et al.
- **类别**: cs.CV, cs.GR
- **备注**: IEEE VR 2026 (journal track) 录用

**摘要**: 仅用 HMD 追踪信号即可在 VR 中实现实时全身 3DGS 数字人的集成系统。采用并行管线：VR 前端用反向运动学估计全身姿态并流式传输到后端，后端从单幅图像重建的 3DGS 数字人进行立体渲染。引入 Binocular Batching 技术将左右眼视图合并为单次批处理渲染，减少冗余计算以支持高分辨率 VR 显示。

---

### 3. LGDWT-GS: Local and Global Discrete Wavelet-Regularized 3D Gaussian Splatting for Sparse-View Scene Reconstruction

- **arXiv**: [2601.17185](https://arxiv.org/abs/2601.17185)
- **作者**: Shima Salehi, Atharva Agashe, Andrew J. McFarland, Joshua Peeples
- **类别**: cs.CV

**摘要**: 稀疏视角 3D 重建中将全局和局部频率正则化集成到 3DGS 中以稳定几何并保留精细细节。引入局部和全局离散小波变换正则化，在稀疏视角条件下抑制伪像并保持频谱一致性。同时发布包含四个光谱波段的开放多光谱温室数据集和标准化少样本重建协议的开源基准包。

---

### 4. A High-Fidelity Digital Twin for Robotic Manipulation Based on 3D Gaussian Splatting

- **arXiv**: [2601.03200](https://arxiv.org/abs/2601.03200)
- **作者**: Ziyang Sun, Lingfan Bao, Tianhu Peng, Jingcheng Sun, Chengxu Zhou
- **类别**: cs.RO
- **备注**: Journal of Robot Learning 录用

**摘要**: 从稀疏 RGB 输入在数分钟内构建高质量、可交互的数字孪生框架。使用 3DGS 进行快速照片级真实感重建作为统一场景表示，通过可见性感知语义融合实现准确 3D 标注，引入基于滤波器的几何转换方法生成可直接集成到 Unity-ROS2-MoveIt 物理引擎的碰撞就绪模型。在 Franka Emika Panda 机器人执行抓取放置任务中验证了闭环操作能力。

---

### 5. Chorus: Multi-Teacher Pretraining for Holistic 3D Gaussian Scene Encoding

- **arXiv**: [2512.17817](https://arxiv.org/abs/2512.17817)
- **作者**: Yue Li, Qi Ma, Runyi Yang, Mengjiao Ma et al.
- **类别**: cs.CV

**摘要**: 多教师预训练框架用于学习全能的 feed-forward 3DGS 场景编码器。从 2D 基础模型蒸馏互补信号，包括语言对齐、通用、和对象感知三个教师，使用共享 3D 编码器和教师特定投影器。在开放词汇语义/实例分割、线性探测、数据高效监督以及 LLM 问答等广泛任务上评估。仅用高斯中心、颜色和估计法线的变体在点云基准上以 39.9 倍更少的训练场景超越点云基线。

---

### 6. Flux4D: Flow-based Unsupervised 4D Reconstruction

- **arXiv**: [2512.03210](https://arxiv.org/abs/2512.03210)
- **作者**: Jingkang Wang, Henry Che, Yun Chen, Ze Yang et al.
- **类别**: cs.CV, cs.LG, cs.RO
- **备注**: NeurIPS 2025

**摘要**: 简单可扩展的大规模动态场景 4D 重建框架。Flux4D 直接预测 3D 高斯及其运动动力学，以完全无监督方式重建传感器观测。仅使用光度损失和"尽可能静态"正则化，无需预训练监督模型或基础先验即可从原始数据中学习分解动态元素。在户外驾驶数据集上实现秒级重建，有效扩展到大数据集，并泛化到未知环境包括罕见和未知物体。

---

### 7. Interactive Augmented Reality-enabled Outdoor Scene Visualization For Enhanced Real-time Disaster Response

- **arXiv**: [2602.21874](https://arxiv.org/abs/2602.21874)
- **作者**: Dimitrios Apostolakis, Georgios Angelidis, Vasileios Argyriou, Panagiotis Sarigiannidis, Georgios Th. Papadopoulos
- **类别**: cs.HC

**摘要**: 以用户为中心的 AR 界面用于灾难响应，使用 3DGS 可视化详细场景重建同时保持情境感知并降低认知负荷。采用轻量交互方式，将世界迷你模型(WIM)导航与语义兴趣点(POIs)结合，可按需过滤，并由支持重建演进时流式更新的后端架构支撑。用户评估表明该设计易于使用并支持实时协调。
...
### 4. DynFOA: Generating First-Order Ambisonics with Conditional Diffusion for Dynamic and Acoustically Complex 360-Degree Videos

- **arXiv**: [2602.06846](https://arxiv.org/abs/2602.06846)
- **作者**: Ziyu Luo, Lin Chen, Qiang Qu, Xiaoming Chen, Yiran Shen
- **类别**: cs.SD

**摘要**: 从 360 度视频自动生成空间音频（一阶高阶 ambisonics, FOA）的生成框架。DynFOA 将动态场景重建与条件扩散建模相结合，分析输入视频检测并定位动态声源、估计深度和语义，使用 3DGS 重建场景几何和材质。重建的场景表示提供物理基础特征以捕获声源、环境和听者视点之间的声学交互。在引入的 M2G-360 数据集（600 个真实世界片段）上评估空间准确性、声学保真度、分布匹配和感知沉浸体验。
...
### 4. SaLF: Sparse Local Fields for Multi-Sensor Rendering in Real-Time

- **arXiv**: [2507.18713](https://arxiv.org/abs/2507.18713)
- **作者**: Yun Chen, Matthew Haines, Jingkang Wang, Sahil Jain et al.
- **类别**: cs.CV, cs.RO
- **备注**: ICRA 2026 录用

**摘要**: 用于实时多传感器仿真的高保真体素表示。SaLF 将体积表示为稀疏 3D 体素基元集合，每个体素为局部隐式场，支持光栅化和光线追踪的统一多传感器模拟。相比 NeRF 和 3DGS 解耦表示与渲染流程，SaLF 支持非针孔相机和旋转 LiDAR。训练时间小于 30 分钟，相机渲染 50+ FPS、LiDAR 渲染 600+ FPS，具有自适应剪枝和加密以轻松处理大场景。

---

### 5. 3D Gaussian Splatting against Moving Objects for High-Fidelity Street Scene Reconstruction

- **arXiv**: [2503.12001](https://arxiv.org/abs/2503.12001)
- **作者**: Peizhen Zheng, Dongjing Jiang, Qingchong Jiao, Redouane EL Bouchtaoui, Flynnwell Jianfei Zhang
- **类别**: cs.CV

**摘要**: 用于动态街道场景重建的 3D 高斯点分布方法。引入自适应透明度机制在保留高保真静态场景细节的同时消除运动物体，通过迭代精炼高斯点分布增强几何精度和纹理表示。集成方向编码与空间位置优化以提高存储和渲染效率，减少冗余同时保持场景完整性。在大尺度动态环境中实现高重建质量、改善渲染性能和适应性。

---

### 6. GSDeformer: Direct, Real-time and Extensible Cage-based Deformation for 3D Gaussian Splatting

- **arXiv**: [2405.15491](https://arxiv.org/abs/2405.15491)
- **作者**: Jiajun Huang, Shuolin Xu, Hongchuan Yu, Tong-Yee Lee
- **类别**: cs.CV

**摘要**: 使 3DGS 支持笼形形变的方法。通过从 3D 高斯生成代理点云表示并将形变从点云翻译为 3D 高斯变换来桥接笼形形变与 3DGS。引入分裂过程近似潜在弯曲，不修改或扩展 3DGS 核心架构，兼容任何训练的 vanilla 3DGS 及其变体。使用渲染-重建方法自动化笼形构建，在极端形变下鲁棒、实时运行且无需重新训练。
...
### 4. Semantic Foam: Unifying Spatial and Semantic Scene Decomposition

- **arXiv**: [2604.26262](https://arxiv.org/abs/2604.26262)
- **作者**: Amr Sharafeldin, Shrisudhan Govindarajan, Thomas Walker, Aryan Mikaeili et al.
- **类别**: cs.CV
- **备注**: CVPR 2026 Highlight 录用

**摘要**: 将 Radiant Foam 的 Voronoi 网格自然空间体素分解与显式语义特征场结合的 3DGS 语义分解方法。在 cell 级别参数化的显式结构支持直接空间正则化，防止遮挡或不一致监督导致的伪像——这是其他点基表示的常见缺陷。相比 Gaussian Grouping 和 SAGA 等最先进方法在对象级分割性能上更优。

---

### 5. VecSet-Edit: Unleashing Pre-trained LRM for Mesh Editing from Single Image

- **arXiv**: [2602.04349](https://arxiv.org/abs/2602.04349)
- **作者**: Teng-Fang Hsiao, Bo-Kai Ruan, Yu-Lun Liu, Hong-Han Shuai
- **类别**: cs.CV, cs.AI

**摘要**: 首个利用高保真 VecSet 大型重建模型(LRM)作为骨干进行网格编辑的管线。通过对 VecSet token 的空间属性分析揭示 token 子集控制不同的几何区域。引入掩码引导 Token 播种和注意力对齐 Token 门控策略，仅使用 2D 图像条件即可精确定位目标区域。设计漂移感知 Token 剪除以在去噪过程中拒绝几何离群值，细节保留纹理烘焙模块确保保留原始网格的几何和纹理信息。

---

### 6. High Dynamic Range 3D Gaussian Splatting via Luminance-Chromaticity Decomposition

- **arXiv**: [2511.12895](https://arxiv.org/abs/2511.12895)
- **作者**: Kaixuan Zhang, Minxian Li, Mingwu Ren, Jiankang Deng, Xiatian Zhu
- **类别**: cs.CV

**摘要**: 探索仅在 HDR 数据空间中学习 HDR 3D 模型的可行性，简化模型设计。分析发现 3DGS 在 HDR 图像上失败源于球面谐波(SH)容量的有限性，难以捕获跨视角的极端辐射度变化。提出亮度-色度分解 3DGS（LCD-GS），将亮度和色度解耦为独立参数，以极小参数增加（如每基元额外一个标量）显著提升学习灵活性。保持原始训练和推理管线，仅需改变颜色表示，自然支持基元级局部和全局亮度编辑。
