...
- [3D Gaussian Splatting 论文分类索引 (2026-03)](#3d-gaussian-splatting-论文分类索引-2026-03)
  ...
  - [二、前馈 3DGS 与可泛化方法 {#cat-feed-forward}](#二前馈-3dgs-与可泛化方法-cat-feed-forward)
  - [三、动态场景与 4D 重建 {#cat-dynamic-4d}](#三动态场景与-4d-重建-cat-dynamic-4d)
  - [四、SLAM 与机器人导航 {#cat-slam-robotics}](#四slam-与机器人导航-cat-slam-robotics)
  - [五、自动驾驶与交通场景 {#cat-autonomous-driving}](#五自动驾驶与交通场景-cat-autonomous-driving)
  - [六、语义分割与场景理解 {#cat-semantics}](#六语义分割与场景理解-cat-semantics)
  - [七、几何与表面重建 {#cat-geometry}](#七几何与表面重建-cat-geometry)
  - [八、渲染加速与压缩 {#cat-accel-compress}](#八渲染加速与压缩-cat-accel-compress)
  - [九、新视角合成 {#cat-nvs}](#九新视角合成-cat-nvs)
  - [十、数字人与头像 {#cat-avatar}](#十数字人与头像-cat-avatar)
  - [十一、生成式模型与编辑 {#cat-generative}](#十一生成式模型与编辑-cat-generative)
  - [十二、逆向渲染与重光照 {#cat-relighting}](#十二逆向渲染与重光照-cat-relighting)
  - [十三、医疗与工业应用 {#cat-medical-industrial}](#十三医疗与工业应用-cat-medical-industrial)
  - [十四、视觉定位与水印安全 {#cat-loc-security}](#十四视觉定位与水印安全-cat-loc-security)
  - [十五、流媒体与编码 {#cat-streaming}](#十五流媒体与编码-cat-streaming)
  - [十六、其他应用与交叉领域 {#cat-other}](#十六其他应用与交叉领域-cat-other)
  - [统计概览](#统计概览)
